...
(function () {
  ...
  C.heroSubs = [
    ...
    'קבוצות פייסבוק, לוחות הוראה, ויועצת אחת ש"אולי מכירה מישהי" — נמאס לכם? גם לנו. אספנו את הכל למקום אחד. הרשמה חינם.',
  ...
  C.emptyJobsFilter = [
    { h: 'אין משרות שעונות לסינון הזה', p: 'נסו להרחיב — לפעמים המשרה הכי טובה היא בעיר השכנה.' },
  ...
  C.emptyTeachersFilter = [
    ...
    { h: 'לא מצאנו מורים לקריטריונים שלכם', p: 'תרגיעו — נמצא. נסו להרחיב את החיפוש.' }
  ];
